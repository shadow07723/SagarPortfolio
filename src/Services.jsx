...
function Services({ services }) {
  return (
    <div className="grid justify-center container mx-auto p-4 min-w-[320px] shadow-md shadow-gray-900 my-5 rounded-xl">
      ...
      <div id="Services" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 container mx-auto p-4 min-w-[320px] shadow-md shadow-gray-900 my-5 rounded-xl  overflow-x-auto">
